  ...
  render() {
    return (
      <div className='dashboard-contents'>
        ...
        {this.props.currentContent === 'get-new-card' ? <NewCard newCard = {this.props.newCard} getNewUserCard = {this.props.getNewUserCard} getNewUserCardPremium = {this.props.getNewUserCardPremium} userCards={this.props.userCards} /> : ''}
